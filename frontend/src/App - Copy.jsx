                    ...
                    <main>
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                ...
                                <ServiceCard title="Integration Lab" svgPath="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9V3m0 18a9 9 0 009-9m-9 9a9 9 0 00-9-9" disabled={true} />
                            </div>
                        </section>
                    </main>
                </div>
...
function App() {
    const [view, setView] = useState('initial'); // 'initial', 'landing', 'prototype', 'app-lab'
